...
| Item | Especificação |
|------|---------------|
| **Computador** | PC ou notebook (Windows/Mac). Configuração mínima: Intel i3 ou i5, 4-8 GB RAM, HD 1TB  |
| **Sistema operacional** | Windows (com ASIO4ALL) ou macOS (Core Audio nativo) |

### 2. Interfaces de Áudio

| Modelo | Características | Faixa de Preço (USD) |
|--------|----------------|---------------------|
| **Behringer U-Phoria UM2** | 2x2 USB, 1 entrada combo XLR/TRS, 1 entrada instrumento P10, pré XENYX, 48V, Direct Monitor, resolução 16-bit/48kHz, alimentação USB  | ~$49 |
| **M-Audio M-Track Solo** | 1 entrada XLR/TRS combo, 1 entrada instrumento Hi-Z, préamp Crystal (EIN -128dBu), +48V, hardware monitoring, resolução 24-bit/48kHz, 1 saída de fone (3.5mm)  | ~$50 |
| **M-Audio M-Track Duo** | 2 entradas XLR/TRS combo, 2 entradas instrumento Hi-Z, préamp Crystal, +48V, hardware monitoring, resolução 24-bit/48kHz, saída de fone TRS, saídas balanceadas TRS  | ~$70 |
...
| Instrumento | Marca | Modelo | Detalhes do Corpo/Material |
|-------------|-------|--------|---------------------------|
| **Contrabaixo** | SX | Precision Bass | Corpo em Ash (madeira que proporciona brilho e sustain) |
| **Guitarra** | SX | **Telecaster Ash Series** | Corpo em **Swamp Ash** (madeira que produz som brilhante, com muito ataque e sustain característico do modelo Telecaster) |
...
|--------|-----------|-----------------|-------------|
| **AMW Mini 32 Black** | 32 | USB, alimentação USB, 1 entrada pedal, Pitch Bend, Modulação, Plug & Play | ~$75 |
| **AMW A49** | 49 | USB, MIDI Out, 1 entrada pedal, Pitch Bend, Modulação, Plug & Play | ~$154 |
| **Waldman Krypton 61** | 61 | USB, MIDI Out, alimentação USB ou fonte, 2 entradas pedal, Knobs extras endereçáveis, Pitch Bend, Modulação | ~$270 |

### 6. Cordas (com tensões especificadas)

| Instrumento | Marca | Tensão | Calibres |
|-------------|-------|--------|----------|
| **Guitarra** | Solez | **0.9 (009-042)** - tensão leve/fácil de tocar | .009 / .011 / .016 / .024 / .032 / .042 |
| **Contrabaixo** | Solez | **Tensão média/leve (Medium/Light)** - fácil de tocar, confortável para iniciantes | Exemplo de referência SIT DE45105L: .045 / .065 / .085 / .105  |
| **Violão de Nylon** | Solez | **Tensão média** (equilíbrio entre conforto e projeção) | Cordas de Nylon com enrolamento nos graves |

### 7. Cabos e Conexões

| Item | Tipo | Uso |
|------|------|-----|
| Cabo USB | USB padrão (USB-A para USB-B) | Interface de áudio / Teclado controlador |
| Cabo P10 (TS) | 1/4" mono | Contrabaixo e guitarra à interface |
| Cabo XLR | 3 pinos (macho/fêmea) | Microfones à interface |
| Cabo TRS 1/4" | balanceado | Conexão de monitores (caixas) à interface  |
| Cabo P10-P2 | Adaptador | Conexão alternativa (celular como microfone) |
...
| Categoria | Equipamento | Faixa de Preço (USD) |
|-----------|-------------|---------------------|
| **Interface (entrada)** | Behringer UM2 | ~$49 |
| **Interface (entrada)** | M-Audio M-Track Solo | ~$50 |
| **Interface (entrada)** | M-Audio M-Track Duo | ~$70 |
| **Interface (intermediária)** | Focusrite Scarlett Solo | ~$139 |
| **Interface (intermediária)** | Focusrite Scarlett 2i2 | ~$199 |
| **Microfone (dinâmico)** | AKG P3S | ~$59 |
| **Microfone (dinâmico)** | Shure SM57/SM58 | ~$99 |
| **Microfone (condensador)** | Audio-Technica AT2020 | ~$99 |
| **Microfone (condensador)** | MXL V67G | ~$119 |
| **Contrabaixo** | SX Precision Bass (Ash) | ~$150-200 |
| **Guitarra** | SX Telecaster Ash Series | ~$150-200 |
| **Violão de Nylon** | **EKO NXT N100CWE** | ~$110-160 |
| **Teclado MIDI** | AMW Mini 32 Black | ~$75 |
| **Teclado MIDI** | AMW A49 | ~$154 |
